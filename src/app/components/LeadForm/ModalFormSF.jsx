...
const ModalFormSF = ({
  ...
  async function getSalesforceAccessToken() {
    const url =
      "https://velocity-speed-3876.my.salesforce.com/services/oauth2/token";
    const formData = new URLSearchParams();
    formData.append("grant_type", "password");
    formData.append(
      "client_id",
      "3MVG95mg0lk4bath3P0wsRv34QU3hcG4X7nJXJA3QJhhQyN7zM0oAA9SJSzj615ZRwEta4KWXFyCMjkIx_ZQy"
    );
    formData.append(
      "client_secret",
      "347AC2A3BCA22AFA96F29043FC175553277A56925A67DD83681745EBC18BF1E3"
    );
    formData.append("username", "adminprod@support.com");
    formData.append("password", "oasisprod@123arPTZ17ooXz0Hdfl4hAZiaKU");
  ...
  const handleSubmit = async (e) => {
    ...
    if (referal) {
      dataObject.Notes = referalFieldValue;
        ...
        try {
          const url =
            "https://velocity-speed-3876.my.salesforce.com/services/data/v60.0/sobjects/Lead/";

...
const LeadFormCopy = ({
  ...
  const handleSubmit = async (e) => {
    ...
    const fullname = document.getElementById("fullnamec").value;
    const mobile = document.getElementById("mobilec").value;
    const strippedMobile = stripPrefix(mobile);
    // const location = document.getElementById("location").value;
    // const branch = document.getElementById("branch").value;
    const gender = document.getElementById("genderc").value;
    const age = document.getElementById("agec").value;
    ...
    if (referal) {
      referalFieldValue = document.getElementById("referalNamec").value;
    ...
    <>
      <div className="col-md-4 oasis-startjour frm" >
        ...
        <div className="oasis-form" data-aos="fade-up">
          ...
          <form className="copy" onSubmit={handleSubmit}>

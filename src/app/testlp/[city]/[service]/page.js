...
export async function generateMetadata({ params}) {
  ...
  const pageTitle = `Oasis ${capitalizedCity} | Top ${service} Clinic in ${capitalizedCity}`;
...
export default function Page({ params }) {
  ...
  return (
    <>
      ...
      {/* <HeroSectionU center={filteredCity} service={service} testlp={true} /> */}
      <HeroSection center={filteredCity} service={service} testlp={true} />
